            ...
            <form >
                <div className="row blog-form" ref="container">
                    ...
                    <div className="columns small-12 large-12 text-center blog-header">
                        <input type="text" value={this.state.title} onChange={this.handleChangeTitle} placeholder="Title For Your Blog"/>
                    </div>
                    <div className="columns small-6-collapse medium-6-collapse large-5-collpase">
                        <textarea value={this.state.intro} onChange={this.handleChangeIntro} cols="30" rows="10"></textarea>
                    </div>
                    <div>
